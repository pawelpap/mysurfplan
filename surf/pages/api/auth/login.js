...
const DUMMY_HASH =
  "msp-scrypt-v1$16384$8$1$BwcHBwcHBwcHBwcHBwcHBw$LJDREFzSy_Scn3GoIZAx4GV9IAuVZNT5EwalTTduW95H2NRFQ1dqh5DSbjFaz_gat9OxGOfpP6_I77oyEaUKCw";
const invalid = (res) =>
  res
    .status(401)
    ...
    const buckets = loginBuckets(
      ...
      process.env.SESSION_SECRET ||
        (process.env.NODE_ENV === "development"
          ? "development-only-login-rate-secret"
          : ""),
    );
