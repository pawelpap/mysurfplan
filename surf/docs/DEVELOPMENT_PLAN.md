...
Finish F18 staging verification and obtain the owner’s review before promoting the Conditions UX to production. See the [implementation contract](CONDITIONS_UX_IMPLEMENTATION.md) and [handover](HANDOVER.md). B2 authorisation is already deployed on both environments; do not repeat its migration.
