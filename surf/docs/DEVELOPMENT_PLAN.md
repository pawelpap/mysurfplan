...
A new 17 September São Pedro review concerns Saturday 19 September. Surfline and our GFS inputs differ in swell bearing, height and partition ordering. The owner authorised a provisional assumption-based calibration for both breaks: staging Bico/Bafureira now admit a broader sheltered GFS direction range, retaining raw bearings and distinct break rules. [Exact settings, replay, live verification and remaining uncertainty](archive/calibration/SAO_PEDRO_DIRECTION_REVIEW_2026-09-17.md). This does not reopen the earlier comparison or establish measured accuracy. Production is unchanged and remains on hold.

Historical baseline: on 16 September both live domains and GitHub deployment branches were verified at documentation commit `04d9c9a8ba15e06406ceae6101154cc391719a34`, containing runtime `e6cfee77ee0517950107d0f01a76b7e0f900373f` from the [13 September typography release](archive/releases/RELEASE_2026-09-13_EMAIL_TYPOGRAPHY.md). Production retains that baseline; staging now contains the 17 September small-wave/window release described above. The [handover](HANDOVER.md) owns current deployment IDs and verification limits. B2 global accounts/memberships, F18 Conditions, the translation fix, temporary public demo, A8 Frankfurt migration and the disabled email foundation are delivered. Self-registration, localisation and published privacy/terms remain unimplemented.
