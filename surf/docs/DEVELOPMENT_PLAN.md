...
Current application revision on staging and production: `428d35f3c2b4b03bec3d95edff4f806945e2690f`, the 7 September forecast tile cleanup. Staging passed before the owner-authorised production deployment; both environments passed API and desktop/mobile checks. “Long-range” and the selected-day outlook reminder were removed without adding probability. The revocable-session release remains in place, as does expiry/cookie hardening. See [current release](RELEASE_2026-09-07_FORECAST_CALIBRATION.md) and [session revocation release](RELEASE_2026-09-07_SESSION_REVOCATION.md).
