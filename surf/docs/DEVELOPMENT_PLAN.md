...
The owner approved F17’s [Conditions Figma proposal](CONDITIONS_UX_FIGMA_REVIEW.md) and authorised F18 on staging. The [implementation contract](CONDITIONS_UX_IMPLEMENTATION.md) records the final refinements: spot cards for now in daylight or the next sunrise at night, five-minute batched summary caching, smaller mobile carousel cards, stable noon day tiles, linked surf/energy and tide detail charts with one time label, equal parameter weight and full mobile tile information. Production promotion waits for the owner’s staging review. Forecast calculations and calibrations remain unchanged.
