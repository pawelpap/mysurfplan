...
Operator details supplied by the owner: **PAWEL PAPLINSKI; tax number PT311219217**. Legal form, correspondence address, privacy contact and VAT status still require confirmation. Treat these as document-publication gates, not fields to invent.
