...
The next staging candidate combines the conditions-layout review with light/dark appearance, restored surf-quality colours and automatic nearest-spot ordering. Local verification is complete; staging deployment and live checks are the next step. The previous staging application was `48b3a4951e84b9eaa71a9de9a220141a10f2e03b`, recorded by documentation commit `a78c52bc523e255177a870723d0a1c6e5fe2f8ca`. The owner must test the new candidate and explicitly approve production before promotion. Approval of previous releases is not approval of this one.
