...
The daylight/cache/mobile follow-up passed 104 unit tests and build; the main change passed 14 API groups and nine browser groups locally and on staging; it has a separate [release record](archive/releases/RELEASE_2026-09-10_SPOT_CARDS_DAYLIGHT.md). See the handover for live staging status.
